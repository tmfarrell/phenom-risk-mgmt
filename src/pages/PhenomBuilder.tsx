...
const generateModelDescription = (model: PreBuiltModel) => {
  ...
  if (isMedication) {
    ...
    parts.push(`This model identifies patients at top ${model.risk_threshold_pct}% probability of ${model.indication_code} within ${formatPredictionTimeframe(model.prediction_timeframe_yrs)}`)
  }
